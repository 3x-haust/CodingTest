...
static long long getGridCount(Area a, int n, int m) {
    ...
    if (a.minx < m - a.miny) result -= getOutGridCount(a.minx, a.miny, m - a.miny - a.minx, m);
    if (a.maxx - m > a.miny) result -= getOutGridCount(a.maxx, a.miny, a.maxx - m - a.miny, m); 
    if (a.minx < a.maxy - m) result -= getOutGridCount(a.minx, a.maxy, a.maxy - m - a.minx, m);
    if (a.maxx - n > n + m - a.maxy) result -= getOutGridCount(a.maxx, a.maxy, a.maxx - n - (n + m - a.maxy), m);
    return result; 
}
